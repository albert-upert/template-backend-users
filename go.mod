module github.com/albert-upert/template-backend-users

go 1.25.5

require (
	github.com/albert-upert/template-backend-utils-framework v1.0.2
	github.com/albert-upert/template-backend-utils-libraries v1.0.6
